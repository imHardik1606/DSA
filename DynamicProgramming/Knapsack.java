public class Knapsack {
    public static int recKnapsack(int val[], int wt[], int W, int n) {// O(2^n)
        if (W == 0 || n == 0) {
            return 0;
        }
        ...
        if (wt[n - 1] <= W) { // valid
            // include
            int ans1 = val[n - 1] + recKnapsack(val, wt, W - wt[n - 1], n - 1);
            // exclude
            int ans2 = recKnapsack(val, wt, W, n - 1);
    ...
    public static int memoKnapsack(int val[], int wt[], int W, int n, int dp[][]) { // O(n * W)
        if (W == 0 || n == 0) {
            return 0;
        }
